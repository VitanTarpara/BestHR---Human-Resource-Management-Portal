"""
Django settings for hres project.
...
SECRET_KEY = '46x9-lfm=8jxna^545ud%8ey)+$f^@dcp2hl5r()n%0^6^d(01'
...
WSGI_APPLICATION = 'hres.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'hres.sqlite3'),
    }
}
